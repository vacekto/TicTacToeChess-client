...
const MenuTicTacToe: React.FC<IMenuTicTacToeProps> = () => {
    ...
    return <svg viewBox={`0 0 ${viewboxSize} ${viewboxSize}`}>
        ...
        <line x1={intersections.first} y1={shift} x2={intersections.first} y2={viewboxSize - shift} stroke="black" strokeWidth={lineWidth} />
        <line x1={intersections.second} y1={shift} x2={intersections.second} y2={viewboxSize - shift} stroke="black" strokeWidth={lineWidth} />

        <line x1={shift} y1={intersections.first} x2={viewboxSize - shift} y2={intersections.first} stroke="black" strokeWidth={lineWidth} />
        <line x1={shift} y1={intersections.second} x2={viewboxSize - shift} y2={intersections.second} stroke="black" strokeWidth={lineWidth} />
